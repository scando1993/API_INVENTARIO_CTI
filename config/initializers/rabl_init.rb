...
if defined?(Rabl)
  ...
  Rabl.configure do |config|
    ...
    config.json_engine = ::MultiJson # Class with #dump class method (defaults JSON)
    config.msgpack_engine = ::MessagePack # Defaults to ::MessagePack
    config.bson_engine = ::BSON # Defaults to ::BSON
    config.plist_engine = ::Plist::Emit # Defaults to ::Plist::Emit
